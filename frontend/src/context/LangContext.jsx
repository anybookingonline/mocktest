...
const strings = {
  en: {
    ...
    'sch.g2.p1': 'Kahoot-style: host screen on the projector, students join from phones with a 4-digit PIN',
    ...
    'sch.g2.p4': 'Student-only apps (Testbook/Adda247) do NOT have this feature',
    ...
    'sch.g3.p3': 'Class is green → zero AI cost — you only pay when students are confused',
    'sch.g4.t': 'Personality & Soft Skills (NEP-aligned)',
    'sch.g4.p1': 'GD Simulator — AI group discussion with 3-4 personas + feedback',
    ...
    'sch.s4.t': 'Go full school', 'sch.s4.d': 'Happy with the pilot? Annual plan — per-student pricing, school-wide rollout.',
    ...
    'sch.f5.q': '🎓 Is there anything for teachers?', 'sch.f5.a': 'Yes — Guru Studio: AI Teach Kits, Kahoot-style Classroom Live Quiz and Soft Skills (GD, speech, personality report). Teachers only need to know PDF upload — AI does the rest.',
  ...
  hinglish: {
    ...
    'sch.g2.p1': 'Kahoot-style: projector par host screen, students phone se 4-digit PIN se join',
    'sch.g2.p2': '15-sec timer, live leaderboard, speed bonus, winner celebration',
    'sch.g2.p3': 'Modes: Rapid Fire · Team Battle · Revision Rumble (due revision ke questions)',
    'sch.g2.p4': 'Ye feature student-only apps (Testbook/Adda247) ke paas NAHI hai',
    'sch.g3.t': 'Confusion Check — 2-second class pulse',
    ...
    'sch.g3.p3': 'Class green hai to zero AI cost — sirf samajh na aaye to kharcha',
    'sch.g4.t': 'Personality & Soft Skills (NEP-aligned)',
    'sch.g4.p1': 'GD Simulator — AI 3-4 personas ke saath group discussion + feedback',
    ...
    'sch.s4.t': 'Go full school', 'sch.s4.d': 'Pilot pasand aaye to annual plan — per-student pricing, school-wide rollout.',
    'sch.pricing.t': 'Pricing — simple, per student',
    ...
    'sch.f5.q': '🎓 Teachers ke liye bhi kuch hai?', 'sch.f5.a': 'Haan — Guru Studio: AI Teach Kits, Kahoot-style Classroom Live Quiz aur Soft Skills (GD, speech, personality report). Teachers ko sirf PDF upload aana chahiye — AI baaki karta hai.',
    'sch.foot.tag': 'AI-Powered Test Practice',
  ...
  hi: {
    ...
    'sch.g2.p1': 'Kahoot-शैली: प्रोजेक्टर पर होस्ट स्क्रीन, छात्र फ़ोन से 4-अंकीय PIN से जुड़ें',
    ...
    'sch.g2.p4': 'यह सुविधा केवल-छात्र ऐप्स (Testbook/Adda247) के पास नहीं है',
    ...
    'sch.g3.p3': 'कक्षा हरी है तो शून्य AI लागत — जब समझ न आए तभी खर्च',
    'sch.g4.t': 'व्यक्तित्व और सॉफ़्ट स्किल्स (NEP-अनुरूप)',
    'sch.g4.p1': 'GD सिम्युलेटर — 3-4 परसोना के साथ AI समूह चर्चा + फ़ीडबैक',
    ...
    'sch.s4.t': 'पूरा स्कूल जोड़ें', 'sch.s4.d': 'पायलट पसंद आए तो वार्षिक योजना — प्रति-छात्र मूल्य, पूरे स्कूल में रोलआउट।',
    ...
    'sch.f5.q': '🎓 शिक्षकों के लिए भी कुछ है?', 'sch.f5.a': 'हाँ — गुरु स्टूडियो: AI टीच किट, Kahoot-शैली क्लासरूम लाइव क्विज़ और सॉफ़्ट स्किल्स (GD, भाषण, व्यक्तित्व रिपोर्ट)। शिक्षकों को बस PDF अपलोड आना चाहिए — AI बाकी करता है।',
