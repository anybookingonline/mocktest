...
const strings = {
  en: {
    ...
    'cf.qbank.d': 'Fresh AI-generated questions via DeepSeek with Gemini fallback — practice sets tayyar jab bhi bank me naye questions chahiye.',
    ...
    'pu.power.d': 'The full AI boost — up to 50 AI Tutor doubts/day (free plan: 15/day, fair-use), unlimited AI mock generation, priority queue.',
    'pu.voice.t': 'Voice Doubts',
    'pu.voice.d': 'Ask by speaking instead of typing — Hindi/English voice input, instant text answer. Handy when typing is inconvenient.',
    ...
    // — Landing: Home FAQ (also rendered as FAQPage structured data) —
    'faq.home.t': 'Frequently asked questions',
    'hq1.q': 'What is Aisepadho?', 'hq1.a': 'Aisepadho is an AI-powered mock test and practice platform for India’s top competitive exams — AI-generated questions, previous year papers, adaptive practice and real exam simulation.',
    'hq2.q': 'Is Aisepadho free to use?', 'hq2.a': 'Yes — you can start practicing for free. Optional power-ups (voice doubt solving, Current Affairs Pro, AI Focus Areas) unlock extra features.',
    'hq3.q': 'Which exams does Aisepadho cover?', 'hq3.a': 'JEE Main, NEET UG, UPSC CSE, SSC CGL, Banking PO, CAT, GATE and CUET UG — plus any custom exam your school or coaching adds.',
    'hq4.q': 'Does Aisepadho work in Hindi?', 'hq4.a': 'Yes — ask doubts in Hindi, Hinglish or English (voice supported too), and question papers can be bilingual.',
    'hq5.q': 'Do I need to install an app?', 'hq5.a': 'No — it runs in your browser on phone or laptop. You can optionally install it as a PWA for a native-app feel.',
    'hq6.q': 'How does the AI question bank work?', 'hq6.a': 'Fresh questions are generated by AI (DeepSeek with Gemini fallback) from previous year papers and your target exam pattern, so practice sets never run stale.',
    ...
    'sch.num.ai.v': 'AI', 'sch.num.ai': 'AI question generation (quota-controlled, no surprise bills)',
  ...
  hinglish: {
    ...
    // — Landing: core features —
    'cf.qbank.t': 'AI Question Bank',
    'cf.qbank.d': 'DeepSeek se fresh AI questions, Gemini fallback ke saath — har baar naya set.',
    'cf.pyq.t': 'Previous Year Papers',
    ...
    'pu.power.t': 'AI Power Pack',
    'pu.power.d': 'AI ka full boost — 50 tak AI Tutor doubts/day (free plan: 15/din, fair-use), unlimited AI mock generation, priority queue.',
    'pu.voice.t': 'Voice Doubts',
    'pu.voice.d': 'Type karne ki jagah bolkar sawal poocho — Hindi/English voice input, turant text me jawab. Typing inconvenient ho tab kaam aata hai.',
    'pu.ca.t': 'Current Affairs Pro',
    ...
    // — Landing: Home FAQ (also rendered as FAQPage structured data) —
    'faq.home.t': 'Aksar poochhe jaane wale sawal',
    'hq1.q': 'Aisepadho kya hai?', 'hq1.a': 'Aisepadho ek AI-powered mock test aur practice platform hai India ke top competitive exams ke liye — AI-generated questions, previous year papers, adaptive practice aur real exam simulation.',
    'hq2.q': 'Kya Aisepadho free hai?', 'hq2.a': 'Haan — practice free me shuru kar sakte ho. Optional power-ups (voice doubt solving, Current Affairs Pro, AI Focus Areas) extra features unlock karte hain.',
    'hq3.q': 'Aisepadho kaun se exams cover karta hai?', 'hq3.a': 'JEE Main, NEET UG, UPSC CSE, SSC CGL, Banking PO, CAT, GATE aur CUET UG — plus koi bhi custom exam jo aapka school ya coaching add kare.',
    'hq4.q': 'Kya Aisepadho Hindi me kaam karta hai?', 'hq4.a': 'Haan — doubts Hindi, Hinglish ya English me pooch sakte ho (voice bhi), aur question papers bilingual ho sakte hain.',
    'hq5.q': 'Kya app install karni padegi?', 'hq5.a': 'Nahi — browser me chalta hai phone ya laptop dono par. Chaho to PWA ke roop me install kar sakte ho, native-app jaisa feel milta hai.',
    'hq6.q': 'AI question bank kaise kaam karta hai?', 'hq6.a': 'Fresh questions AI se generate hote hain (DeepSeek, Gemini fallback ke saath) previous year papers aur aapke target exam pattern se — practice sets kabhi stale nahi hote.',
    ...
    'sch.num.exams.v': '8+', 'sch.num.exams': 'Exams supported out of the box',
    'sch.num.ai.v': 'AI', 'sch.num.ai': 'AI question generation (quota-controlled, koi surprise bill nahi)',
  ...
  hi: {
    ...
    'cf.qbank.d': 'DeepSeek से ताज़ा AI प्रश्न, Gemini फ़ॉलबैक के साथ — हर बार नया सेट।',
    ...
    'pu.power.d': 'AI का पूरा बूस्ट — रोज़ाना 50 तक AI ट्यूटर डाउट (फ्री प्लान: 15/दिन, fair-use), असीमित AI मॉक जनरेशन, प्राथमिकता क्यू।',
    'pu.voice.t': 'वॉइस संदेह',
    'pu.voice.d': 'टाइप करने की बजाय बोलकर प्रश्न पूछें — हिंदी/अंग्रेज़ी वॉइस इनपुट, तुरंत टेक्स्ट में जवाब। टाइपिंग असुविधाजनक हो तब काम आता है।',
    ...
    // — Landing: Home FAQ (also rendered as FAQPage structured data) —
    'faq.home.t': 'अक्सर पूछे जाने वाले सवाल',
    'hq1.q': 'Aisepadho क्या है?', 'hq1.a': 'Aisepadho एक AI-powered mock test और practice platform है भारत की टॉप competitive exams के लिए — AI-generated questions, previous year papers, adaptive practice और real exam simulation।',
    'hq2.q': 'क्या Aisepadho फ्री है?', 'hq2.a': 'हाँ — practice फ्री में शुरू कर सकते हैं। Optional power-ups (voice doubt solving, Current Affairs Pro, AI Focus Areas) एक्स्ट्रा features अनलॉक करते हैं।',
    'hq3.q': 'Aisepadho कौन से exams कवर करता है?', 'hq3.a': 'JEE Main, NEET UG, UPSC CSE, SSC CGL, Banking PO, CAT, GATE और CUET UG — साथ ही कोई भी custom exam जो आपका school या coaching जोड़े।',
    'hq4.q': 'क्या Aisepadho हिंदी में काम करता है?', 'hq4.a': 'हाँ — doubts हिंदी, Hinglish या English में पूछ सकते हैं (voice भी), और question papers bilingual हो सकते हैं।',
    'hq5.q': 'क्या ऐप इंस्टॉल करनी पड़ेगी?', 'hq5.a': 'नहीं — यह ब्राउज़र में फ़ोन या लैपटॉप दोनों पर चलता है। चाहें तो PWA के रूप में इंस्टॉल कर सकते हैं, native-app जैसा feel मिलता है।',
    'hq6.q': 'AI question bank कैसे काम करता है?', 'hq6.a': 'नए questions AI से generate होते हैं (DeepSeek, Gemini fallback के साथ) previous year papers और आपके target exam pattern से — practice sets कभी stale नहीं होते।',
    ...
    'sch.num.ai.v': 'AI', 'sch.num.ai': 'AI प्रश्न निर्माण (कोटा-नियंत्रित, कोई अचानक बिल नहीं)',
