...
const strings = {
  en: {
    ...
    'pu.power.d': 'The full AI boost — unlimited AI Tutor doubts (free plan: 15/day), AI Focus Areas, unlimited Quiz Battles and priority generation.',
  ...
  hinglish: {
    ...
    'pu.power.t': 'AI Power Pack',
    'pu.power.d': 'AI ka full boost — unlimited AI Tutor doubts (free plan: 15/din), AI Focus Areas, unlimited Quiz Battles aur priority generation.',
    'pu.voice.t': 'Voice Doubts',
  ...
  hi: {
    ...
    'pu.power.d': 'AI का पूरा बूस्ट — असीमित AI ट्यूटर डाउट (फ्री प्लान: 15/दिन), AI फ़ोकस एरिया, असीमित क्विज़ बैटल और प्राथमिकता जनरेशन।',
